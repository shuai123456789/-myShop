...
@Configuration
@EnableAsync
public class TaskExecutionProperties implements AsyncConfigurer {

    private static final Logger logger = LoggerFactory.getLogger(TaskExecutionProperties.class);
